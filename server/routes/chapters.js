...
// ============================================
// DELETE /api/chapters/all - 모든 데이터 삭제 (/:id 보다 먼저!)
// ============================================
...
// ============================================
// POST /api/chapters/seed - 서울 48개 지역구 시드 데이터 (/:id 보다 먼저!)
// ============================================
...
// ============================================
// POST /api/chapters/reorder - 드래그앤드롭 순서 재정렬 (/:id 보다 먼저!)
// ============================================
