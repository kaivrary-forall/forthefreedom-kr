...
const ADMIN_CREDENTIALS = {
    username: process.env.ADMIN_USERNAME || 'admin_00',
    password: process.env.ADMIN_PASSWORD || 'RlaQkqdpRladjqtEk!1',
    role: 'super_admin',
    id: 'admin_001',
    nickname: '슈퍼관리자',
    name: '슈퍼관리자'
...
module.exports = { router, verifyToken, ADMIN_CREDENTIALS, initializeAdminPassword }; 