...
router.get('/security-status', verifyToken, async (req, res) => {
    ...
    try {
        ...
        const activeRefreshTokenCount = await RefreshToken.countDocuments();
        ...
        res.json({
            ...
            security: {
                ...
                activeRefreshTokens: activeRefreshTokenCount,
