        ...
        <nav class="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
                    ...
                    <div class="flex items-center gap-8">
                        ...
                        <div class="hidden md:flex items-center gap-8">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute left-0 top-full mt-2 w-56 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0">
                                    <div class="py-2">
                                        <a href="${pathPrefix}committees/index.html" class="block px-4 py-2 text-base text-[#212121] hover:bg-gray-50 hover:text-[#a50034]">전체 위원회</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="mobile-menu" class="md:hidden hidden border-t border-gray-200">
                    <div class="py-2 space-y-1">
                        ...
                        <!-- 직능위원회 메뉴 -->
                        <div class="mobile-menu-item">
                            <button onclick="toggleMobileSubmenu('committees-submenu')" class="w-full flex items-center justify-between px-3 py-2 text-lg text-gray-700 hover:bg-gray-50 hover:text-red-600">
                                <span class="font-bold">직능위원회</span>
                                <i class="fas fa-chevron-down transition-transform duration-200" id="committees-submenu-icon"></i>
                            </button>
                            <div id="committees-submenu" class="hidden bg-gray-50 border-l-4 border-red-600 ml-3">
                                <a href="${pathPrefix}committees/index.html" class="block px-6 py-2 text-base text-gray-600 hover:bg-gray-100 hover:text-red-600">전체 위원회</a>
                            </div>
                        </div>
