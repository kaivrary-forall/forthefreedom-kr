...
function loadAdminNav(currentPage) {
    ...
    const pages = {
        ...
        personnel: currentPage === 'personnel',
        congratulations: currentPage === 'congratulations'
    };
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <!-- 인사/경조사 드롭다운 -->
                        <div class="relative group">
                            <button class="px-3 py-2 text-sm font-medium rounded-md transition-colors flex items-center ${pages.personnel || pages.congratulations ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'}">
                                소식 게시판 ▾
                            </button>
                            <div class="absolute left-0 mt-1 w-40 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                <a href="personnel.html" class="block px-4 py-2 text-sm ${pages.personnel ? 'text-primary bg-primary/5' : 'text-gray-700 hover:bg-gray-50'}">
                                    인사공고
                                </a>
                                <a href="congratulations.html" class="block px-4 py-2 text-sm ${pages.congratulations ? 'text-primary bg-primary/5' : 'text-gray-700 hover:bg-gray-50'}">
                                    경조사
                                </a>
                            </div>
                        </div>
        ...
        <div id="mobileMenu" class="md:hidden hidden bg-white border-t border-gray-200">
            <div class="px-4 py-3 space-y-1">
                ...
                <div class="border-t border-gray-100 my-2 pt-2">
                    ...
                    <a href="personnel.html" class="block px-3 py-2 rounded-md text-sm font-medium ${pages.personnel ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-gray-100'}">
                        인사공고
                    </a>
                    <a href="congratulations.html" class="block px-3 py-2 rounded-md text-sm font-medium ${pages.congratulations ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-gray-100'}">
                        경조사
                    </a>
